 ...
 - I had some problem with Next's <Image />, even when i made a config for 'next.config.js' that allow to get the pictures from the ``` ['d35xwkx70uaomf.cloudfront.net'] ```
